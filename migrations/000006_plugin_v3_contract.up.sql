...
CREATE TABLE plugin_services (
  ...
  openapi_url VARCHAR(512) NOT NULL DEFAULT '',
...
CREATE TABLE plugin_route_claims (
  id BIGINT AUTO_INCREMENT NOT NULL,
  plugin_key VARCHAR(64) NOT NULL,
  route_id VARCHAR(64) NOT NULL,
  method VARCHAR(16) NOT NULL,
  ...
  created_at TIMESTAMP(6) NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY uk_plugin_route_claims_identity (plugin_key, method, match_type, gateway_path),
  KEY idx_plugin_route_claims_path (gateway_path, method)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
